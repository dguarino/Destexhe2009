    ...
    'Populations' : {
        'cell' : {
            ...
            'cellparams': {
                ...
                #'a'          : 0.01, # uS, spike-frequency adaptation
                #'b'          : .005,  # nA, increment to the adaptation variable
                # NEURON
                'tau_m'      : 20.0,  # ms, time constant of leak conductance
                'tau_w'      : 600.0, # ms, time constant of adaptation variable
                'cm'         : 0.00005, # nF, 1 uF/cm^2 with 20000 um^2 is the membrane area (NEURON)
                'a'          : 0.001, # uS, spike-frequency adaptation
                'b'          : .04,   # nA, increment to the adaptation variable (NEURON)
